...
namespace QuanLyPhongNet.DAO
{
    ...
    partial void InsertSystemDiary(SystemDiary instance);
    partial void UpdateSystemDiary(SystemDiary instance);
    partial void DeleteSystemDiary(SystemDiary instance);
    ...
    partial void InsertTransacDiary(TransacDiary instance);
    partial void UpdateTransacDiary(TransacDiary instance);
    partial void DeleteTransacDiary(TransacDiary instance);
    #endregion
		...
		public System.Data.Linq.Table<SystemDiary> SystemDiaries
		{
			get
			{
				return this.GetTable<SystemDiary>();
			}
		}
		...
		public System.Data.Linq.Table<TransacDiary> TransacDiaries
		{
			get
			{
				return this.GetTable<TransacDiary>();
			}
		}
	}
    ...
    partial void OnPriceTotalChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_Bill", Storage="_Client", ThisKey="ClientName", OtherKey="ClientName", IsForeignKey=true)]
	...
	public partial class Client : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<SystemDiary> _SystemDiaries;
		
		private EntitySet<TransacDiary> _TransacDiaries;
    ...
    partial void OnNoteChanged();
		...
		public Client()
		{
			...
			this._SystemDiaries = new EntitySet<SystemDiary>(new Action<SystemDiary>(this.attach_SystemDiaries), new Action<SystemDiary>(this.detach_SystemDiaries));
			this._TransacDiaries = new EntitySet<TransacDiary>(new Action<TransacDiary>(this.attach_TransacDiaries), new Action<TransacDiary>(this.detach_TransacDiaries));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_Bill", Storage="_Bills", ThisKey="ClientName", OtherKey="ClientName")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_SystemDiary", Storage="_SystemDiaries", ThisKey="ClientName", OtherKey="ClientName")]
		public EntitySet<SystemDiary> SystemDiaries
		{
			get
			{
				return this._SystemDiaries;
			}
			set
			{
				this._SystemDiaries.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_TransacDiary", Storage="_TransacDiaries", ThisKey="ClientName", OtherKey="ClientName")]
		public EntitySet<TransacDiary> TransacDiaries
		{
			get
			{
				return this._TransacDiaries;
			}
			set
			{
				this._TransacDiaries.Assign(value);
			}
		}
		...
		private void attach_SystemDiaries(SystemDiary entity)
		{
			this.SendPropertyChanging();
			entity.Client = this;
		}
		
		private void detach_SystemDiaries(SystemDiary entity)
		{
			this.SendPropertyChanging();
			entity.Client = null;
		}
		
		private void attach_TransacDiaries(TransacDiary entity)
		{
			this.SendPropertyChanging();
			entity.Client = this;
		}
		
		private void detach_TransacDiaries(TransacDiary entity)
		{
			this.SendPropertyChanging();
			entity.Client = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.SystemDiary")]
	public partial class SystemDiary : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnClientNameChanging(string value);
    partial void OnClientNameChanged();
    partial void OnTransacDateChanging(System.Nullable<System.DateTime> value);
    partial void OnTransacDateChanged();
    partial void OnAddTimeChanging(System.Nullable<System.TimeSpan> value);
    ...
    partial void OnNoteChanged();
		...
		public System.Nullable<System.DateTime> TransacDate
		{
			...
			set
			{
				...
				{
					this.OnTransacDateChanging(value);
					this.SendPropertyChanging();
					this._TransacDate = value;
					this.SendPropertyChanged("TransacDate");
					this.OnTransacDateChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_SystemDiary", Storage="_Client", ThisKey="ClientName", OtherKey="ClientName", IsForeignKey=true)]
		public Client Client
		{
			get
			{
			...
			set
			{
							...
							|| (this._Client.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Client.Entity = null;
						previousValue.SystemDiaries.Remove(this);
					}
					this._Client.Entity = value;
					if ((value != null))
					{
						value.SystemDiaries.Add(this);
						this._ClientName = value.ClientName;
					}
					else
					{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TransacDiary")]
	public partial class TransacDiary : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _TransacTime;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnTransacIDChanging(int value);
    partial void OnTransacIDChanged();
    partial void OnClientNameChanging(string value);
    partial void OnClientNameChanged();
    partial void OnTransacTimeChanging(System.Nullable<System.DateTime> value);
    partial void OnTransacTimeChanged();
    partial void OnStartTimeChanging(System.Nullable<System.TimeSpan> value);
    partial void OnStartTimeChanged();
    partial void OnUseTimeChanging(System.Nullable<System.TimeSpan> value);
    partial void OnUseTimeChanged();
    ...
    partial void OnTotalMoneyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TransacID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TransacTime", DbType="Date")]
		public System.Nullable<System.DateTime> TransacTime
		{
			get
			{
				return this._TransacTime;
			}
			set
			{
				if ((this._TransacTime != value))
				{
					this.OnTransacTimeChanging(value);
					this.SendPropertyChanging();
					this._TransacTime = value;
					this.SendPropertyChanged("TransacTime");
					this.OnTransacTimeChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Client_TransacDiary", Storage="_Client", ThisKey="ClientName", OtherKey="ClientName", IsForeignKey=true)]
		public Client Client
		{
			get
			{
			...
			set
			{
							...
							|| (this._Client.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Client.Entity = null;
						previousValue.TransacDiaries.Remove(this);
					}
					this._Client.Entity = value;
					if ((value != null))
					{
						value.TransacDiaries.Add(this);
						this._ClientName = value.ClientName;
					}
					else
					{
